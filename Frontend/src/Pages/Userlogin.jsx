...
const UserLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const data = await apiRequest(API_ENDPOINTS.USER_LOGIN, {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-green-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-2000"></div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
            ...
            <div className="text-center mb-8">
              <motion.div
                ...
                className="w-20 h-20 bg-gradient-to-r from-blue-400 to-green-500 rounded-2xl flex items-center justify-center mx-auto mb-4"
              >
                <FaUser className="text-3xl text-white" />
              </motion.div>
              <h1 className="text-3xl font-bold text-white mb-2">User Login</h1>
              <p className="text-white/70">Welcome back! Access your community space</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-500 to-green-600 text-white py-4 rounded-2xl font-semibold text-lg hover:from-blue-600 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
